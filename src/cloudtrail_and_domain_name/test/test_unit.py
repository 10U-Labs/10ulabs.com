...
def test_hosted_zone_has_id_output():
    ...
    import importlib.util
    stack_path = Path(__file__).parents[2] / "src" / "cloudtrail_and_domain_name" / "stack.py"
...
def test_lambda_handler_file_exists():
    handler_path = Path(__file__).parents[2] / "src" / "cloudtrail_and_domain_name" / "lambda" / "handler.py"
...
handler_path = Path(__file__).parents[2] / "src" / "cloudtrail_and_domain_name" / "lambda"
...
def test_lambda_directory_contains_handler():
    ...
    lambda_dir = Path(__file__).parents[2] / "src" / "cloudtrail_and_domain_name" / "lambda"
