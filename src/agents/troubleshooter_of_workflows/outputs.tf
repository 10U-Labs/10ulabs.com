output "ecr_repository_url" {
  ...
  value       = data.terraform_remote_state.agents_shared.outputs.ecr_repository_url
}

output "agent_runtime_arn" {
  description = "The ARN of the AgentCore Runtime"
  value       = aws_bedrockagentcore_agent_runtime.troubleshooter_of_workflows.agent_runtime_arn
}
