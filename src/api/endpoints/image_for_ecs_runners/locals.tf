locals {
  ...
  ecr_repository_arn  = data.terraform_remote_state.bootstrap.outputs.ecr_repository_arn
  ecr_repository_name = data.terraform_remote_state.bootstrap.outputs.ecr_repository_name
