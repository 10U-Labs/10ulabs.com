...
def _trigger_api_workflow(github_token: str) -> dict[str, Any]:
    """Trigger the api_common_routing.yml workflow via GitHub API.
    ...
    workflow_file = "api_common_routing.yml"
...
def lambda_handler(event: dict[str, Any], _context: Any) -> dict[str, Any]:
    ...
    if result.get("success"):
        ...
        _send_notification(
            ...
            f"Resource: {drift['summary']}\n"
            f"Rule: {drift['rule_name']}\n\n"
            f"Automatically triggered api_common_routing.yml workflow "
