...
## Task 1: Ensure bootstrap.yml runs without problems

**Status:** Complete

---

## Task 2: Ensure www_shared.yml runs without problems
...
## Task 16: STOP AND ASK USER

After Task 15 completes successfully, stop and ask the user for next steps.
