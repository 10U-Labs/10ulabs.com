Format the following markdown file to fix ALL markdownlint violations. Preserve all content exactly.
...
Example fixes:
Before: "- GitHub Personal Access Token (PAT) in your environment variables as GITHUB_PAT"
After: "- GitHub Personal Access Token (PAT) in your environment variables as \\\nGITHUB_PAT"
...
Output ONLY the fixed content with no preamble, explanations, or markdown code blocks.
