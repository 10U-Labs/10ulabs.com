...
- [The rule](#the-rule)
- [Why the rule is cost](#why-the-rule-is-cost)
- [Reading is not running](#reading-is-not-running)
- [When a change is done](#when-a-change-is-done)
- [What follows for TDD](#what-follows-for-tdd)
