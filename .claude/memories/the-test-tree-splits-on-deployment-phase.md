...
- [Why phase is the top split](#why-phase-is-the-top-split)
- [A directory appears when a test does](#a-directory-appears-when-a-test-does)
- [What decides the tier](#what-decides-the-tier)
...
## A directory appears when a test does
