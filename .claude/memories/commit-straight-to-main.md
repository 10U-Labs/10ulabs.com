...
- [The rule](#the-rule)
- [What the history shows](#what-the-history-shows)
- [CI is the only review there is](#ci-is-the-only-review-there-is)
- [One issue is one commit](#one-issue-is-one-commit)
- [Breaking work down](#breaking-work-down)
...
## CI is the only review there is
