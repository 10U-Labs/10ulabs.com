...
from .conftest import start_runner_container, get_github_runners, wait_for_process_with_backoff, run_runner_and_wait, get_matching_runner
...
def test_runner_appears_online_in_github(ecr_image_uri, github_repo, runner_registration_token, aws_region, github_pat):
    ...
    matching_runners = get_matching_runner(github_pat, github_repo, runner_name)
