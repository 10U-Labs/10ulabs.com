class TestFindOrphanedSnapshotsReturnsOrphanedSet:
    ...
    def test_returns_empty_set_when_no_snapshots(self, cleanup_packer_artifacts, mock_ec2_client):
        mock_ec2_client.describe_images.return_value = {'Images': []}
        mock_ec2_client.describe_snapshots.return_value = {'Snapshots': []}

        result = cleanup_packer_artifacts.find_orphaned_snapshots(mock_ec2_client, set())

        assert result == set()

    def test_returns_orphaned_snapshot_when_ami_does_not_exist(self, cleanup_packer_artifacts, mock_ec2_client):
        mock_ec2_client.describe_images.return_value = {'Images': []}
