...
def test_cloudfront_distribution_exists(
    cloudfront_distribution: Any, www_common_outputs: Dict[str, str]
) -> None:
...
def test_cloudfront_distribution_has_id(cloudfront_distribution: Any) -> None:
    if cloudfront_distribution is None:
...
def test_website_domain_name_output_exists(www_common_outputs: Dict[str, str]) -> None:
...
def test_cloudfront_distribution_id_output_exists(www_common_outputs: Dict[str, str]) -> None:
    distribution_id = www_common_outputs.get("cloudfront_distribution_id")
