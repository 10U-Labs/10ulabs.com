...
def test_terraform_state_bucket_has_force_destroy(bootstrap_dir, v7_compatible):
...
def test_central_logs_bucket_has_force_destroy(bootstrap_dir, v7_compatible):
