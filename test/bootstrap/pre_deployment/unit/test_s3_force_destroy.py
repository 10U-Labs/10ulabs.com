...
def test_terraform_state_bucket_has_force_destroy(bootstrap_dir: Path, v7_compatible: Any) -> None:
...
def test_central_logs_bucket_has_force_destroy(bootstrap_dir: Path, v7_compatible: Any) -> None:
