...
def test_vpc_exists(ec2_client, config):
...
def test_vpc_has_dns_hostnames_enabled(ec2_client, config):
...
def test_vpc_has_dns_support_enabled(ec2_client, config):
...
def test_public_subnets_exist(ec2_client, config):
...
def test_internet_gateway_exists(ec2_client, config):
...
def test_runner_security_group_exists(ec2_client, config):
...
def test_runner_security_group_has_egress_rule(ec2_client, config):
...
def test_runner_security_group_has_no_ingress_rules(ec2_client, config):
