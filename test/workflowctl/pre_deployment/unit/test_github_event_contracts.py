...
class TestGitHubEventContracts:
    ...
    def test_push_event_commits_shape(self, get_changed_files) -> None:
        ...
        result = get_changed_files.filter_files_by_commits(push_commits)
        assert result == set()

    def test_workflow_dispatch_commits_is_null(self, get_changed_files) -> None:
        ...
        result = get_changed_files.filter_files_by_commits(workflow_dispatch_commits)
        assert result == set()

    def test_schedule_event_commits_is_null(self, get_changed_files) -> None:
        ...
        result = get_changed_files.filter_files_by_commits(schedule_commits)
        assert result == set()

    def test_repository_dispatch_commits_is_null(self, get_changed_files) -> None:
        ...
        result = get_changed_files.filter_files_by_commits(repository_dispatch_commits)
        assert result == set()
