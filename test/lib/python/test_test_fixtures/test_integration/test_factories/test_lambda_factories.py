...
def test_create_lambda_api_gateway_wiring_tests_returns_class() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    assert isinstance(test_class, type)


def test_create_lambda_api_gateway_wiring_tests_returns_class_with_name() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    assert test_class.__name__ == "TestLambdaWiring"


def test_has_test_handler_has_api_gateway_permission() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    assert hasattr(test_class, "test_handler_has_api_gateway_permission")


def test_has_test_handler_has_role_attached() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    assert hasattr(test_class, "test_handler_has_role_attached")


def test_has_test_handler_role_follows_naming_pattern() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    assert hasattr(test_class, "test_handler_role_follows_naming_pattern")


def test_handler_has_api_gateway_permission_success() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
...
def test_handler_has_api_gateway_permission_uses_default() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    mock_client = MagicMock()
    mock_client.get_policy.return_value = {
...
def test_handler_has_api_gateway_permission_fails_when_no_permission() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    mock_client = MagicMock()
...
def test_handler_has_api_gateway_permission_fails_on_resource_not_found() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    mock_client = MagicMock()
...
def test_handler_has_api_gateway_permission_reraises_other_errors() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    mock_client = MagicMock()
...
def test_handler_has_role_attached_success() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    mock_client = MagicMock()
...
def test_handler_has_role_attached_fails_when_no_role() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    mock_client = MagicMock()
...
def test_handler_role_follows_naming_pattern_success() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    mock_client = MagicMock()
    mock_client.get_function.return_value = {
...
def test_handler_role_follows_naming_pattern_fails_when_pattern_mismatch() -> None:
    test_class = create_lambda_api_gateway_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    mock_client = MagicMock()
    mock_client.get_function.return_value = {
...
def test_create_lambda_iam_wiring_tests_returns_class() -> None:
    test_class = create_lambda_iam_wiring_tests("func_key", "DefaultFunc")
    assert isinstance(test_class, type)


def test_create_lambda_iam_wiring_tests_returns_class_with_name() -> None:
    test_class = create_lambda_iam_wiring_tests("func_key", "DefaultFunc")
    assert test_class.__name__ == "TestIAMPolicyWiring"


def test_has_test_config_has_function_name() -> None:
    test_class = create_lambda_iam_wiring_tests("func_key", "DefaultFunc")
    assert hasattr(test_class, "test_config_has_function_name")


def test_has_test_service_role_name_follows_convention() -> None:
    test_class = create_lambda_iam_wiring_tests("func_key", "DefaultFunc")
    assert hasattr(test_class, "test_service_role_name_follows_convention")


def test_has_basic_execution_policy_test_when_enabled() -> None:
...
def test_has_lambda_trust_test_when_enabled() -> None:
    test_class = create_lambda_iam_wiring_tests(
...
def test_no_basic_execution_test_when_disabled() -> None:
    test_class = create_lambda_iam_wiring_tests(
...
def test_no_lambda_trust_test_when_disabled() -> None:
    test_class = create_lambda_iam_wiring_tests(
...
def test_config_has_function_name_success() -> None:
    test_class = create_lambda_iam_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    config = {"func_key": "MyFunction"}
...
def test_config_has_function_name_uses_default() -> None:
    test_class = create_lambda_iam_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    config: Dict[str, Any] = {}
    assert accepted(instance.test_config_has_function_name, config)
...
def test_service_role_name_follows_convention_success() -> None:
    test_class = create_lambda_iam_wiring_tests("func_key", "DefaultFunc")
    instance = test_class()
    config = {"func_key": "MyFunction"}
...
def test_handler_role_has_basic_execution_policy_success() -> None:
    test_class = create_lambda_iam_wiring_tests(
        "func_key", "DefaultFunc", check_basic_execution=True
    )
    instance = test_class()
...
def test_handler_role_has_basic_execution_policy_fails_when_missing() -> None:
    test_class = create_lambda_iam_wiring_tests(
        "func_key", "DefaultFunc", check_basic_execution=True
    )
    instance = test_class()
...
def test_handler_role_can_assume_lambda_service_success() -> None:
    test_class = create_lambda_iam_wiring_tests(
        "func_key", "DefaultFunc", check_lambda_trust=True
    )
    instance = test_class()
...
def test_handler_role_can_assume_lambda_service_fails_when_no_trust() -> None:
    test_class = create_lambda_iam_wiring_tests(
        "func_key", "DefaultFunc", check_lambda_trust=True
    )
    instance = test_class()
...
def test_create_lambda_execution_role_wiring_tests_returns_class() -> None:
    test_class = create_lambda_execution_role_wiring_tests()
    assert isinstance(test_class, type)


def test_create_lambda_execution_role_wiring_tests_returns_class_with_name() -> None:
    test_class = create_lambda_execution_role_wiring_tests()
    assert test_class.__name__ == "TestLambdaExecutionRole"


def test_has_test_lambda_has_execution_role_key() -> None:
    test_class = create_lambda_execution_role_wiring_tests()
    assert hasattr(test_class, "test_lambda_has_execution_role_key")


def test_has_test_lambda_has_execution_role_value() -> None:
    test_class = create_lambda_execution_role_wiring_tests()
    assert hasattr(test_class, "test_lambda_has_execution_role_value")


def test_has_test_lambda_role_starts_with_iam_arn() -> None:
    test_class = create_lambda_execution_role_wiring_tests()
    assert hasattr(test_class, "test_lambda_role_starts_with_iam_arn")


def test_has_test_lambda_role_contains_role_path() -> None:
    test_class = create_lambda_execution_role_wiring_tests()
    assert hasattr(test_class, "test_lambda_role_contains_role_path")


def test_lambda_has_execution_role_key_success() -> None:
...
def test_lambda_has_execution_role_value_success() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_request = MagicMock()
    mock_request.getfixturevalue.return_value = {"Role": "arn:aws:iam::123:role/MyRole"}
...
def test_lambda_has_execution_role_value_fails_when_empty() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_request = MagicMock()
...
def test_lambda_role_starts_with_iam_arn_success() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_request = MagicMock()
    mock_request.getfixturevalue.return_value = {"Role": "arn:aws:iam::123:role/MyRole"}
...
def test_lambda_role_starts_with_iam_arn_fails_when_invalid() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_request = MagicMock()
...
def test_lambda_role_contains_role_path_success() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_request = MagicMock()
    mock_request.getfixturevalue.return_value = {"Role": "arn:aws:iam::123:role/MyRole"}
...
def test_lambda_role_contains_role_path_fails_when_missing() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_request = MagicMock()
...
def test_lambda_role_exists_success() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_client = MagicMock()
...
def test_lambda_role_exists_fails_when_no_role_name_extracted() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_client = MagicMock()
    mock_request = MagicMock()
...
def test_lambda_role_can_be_assumed_by_lambda_success() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_client = MagicMock()
    mock_client.get_role.return_value = {
...
def test_lambda_role_can_be_assumed_by_lambda_skips_when_no_role_name() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_client = MagicMock()
    mock_request = MagicMock()
...
def test_lambda_role_can_be_assumed_by_lambda_fails_when_no_trust() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_client = MagicMock()
    mock_client.get_role.return_value = {
...
def test_lambda_role_can_be_assumed_by_lambda_skips_on_no_such_entity() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_client = MagicMock()
...
def test_lambda_role_can_be_assumed_by_lambda_reraises_other_errors() -> None:
    test_class = create_lambda_execution_role_wiring_tests("lambda_config")
    instance = test_class()
    mock_client = MagicMock()
...
def test_create_lambda_existence_tests_returns_class() -> None:
    test_class = create_lambda_existence_tests("func_key", "DefaultFunc", "tf/path")
    assert isinstance(test_class, type)


def test_create_lambda_existence_tests_returns_class_with_name() -> None:
    test_class = create_lambda_existence_tests("func_key", "DefaultFunc", "tf/path")
    assert test_class.__name__ == "TestDeployedResourcesExist"


def test_has_test_handler_lambda_exists() -> None:
    test_class = create_lambda_existence_tests("func_key", "DefaultFunc", "tf/path")
    assert hasattr(test_class, "test_handler_lambda_exists")


def test_has_test_handler_iam_role_exists() -> None:
    test_class = create_lambda_existence_tests("func_key", "DefaultFunc", "tf/path")
    assert hasattr(test_class, "test_handler_iam_role_exists")


def test_has_log_group_test_when_fixture_provided() -> None:
...
def test_handler_iam_role_exists_success() -> None:
    test_class = create_lambda_existence_tests("func_key", "DefaultFunc", "tf/path")
    instance = test_class()
    mock_client = MagicMock()
...
def test_handler_log_group_exists_success() -> None:
    test_class = create_lambda_existence_tests(
        "func_key", "DefaultFunc", "tf/path", log_group_fixture="log_group"
    )
    instance = test_class()
...
def test_handler_log_group_exists_fails_when_not_exists() -> None:
    test_class = create_lambda_existence_tests(
        "func_key", "DefaultFunc", "tf/path", log_group_fixture="log_group"
    )
    instance = test_class()
...
def test_handler_lambda_exists_success() -> None:
    test_class = create_lambda_existence_tests("func_key", "DefaultFunc", "tf/path")
    instance = test_class()
    mock_client = MagicMock()
...
def test_handler_iam_role_exists_fails_when_no_such_entity() -> None:
    test_class = create_lambda_existence_tests("func_key", "DefaultFunc", "tf/path")
    instance = test_class()
    mock_client = MagicMock()
...
def test_expected_handler_has_no_default() -> None:
...
def test_other_configuration_arguments_keep_their_defaults() -> None:
    parameters = inspect.signature(create_lambda_configuration_tests).parameters
    assert all(
...
def test_create_lambda_configuration_tests_returns_class() -> None:
...
def test_create_lambda_configuration_tests_returns_class_with_name() -> None:
    test_class = create_lambda_configuration_tests(
        "func_key", "DefaultFunc", expected_handler="handler.lambda_handler"
    )
...
def test_has_test_handler_uses_python_runtime() -> None:
    test_class = create_lambda_configuration_tests(
        "func_key", "DefaultFunc", expected_handler="handler.lambda_handler"
    )
...
def test_has_test_handler_uses_expected_architecture() -> None:
    test_class = create_lambda_configuration_tests(
        "func_key", "DefaultFunc", expected_handler="handler.lambda_handler"
    )
...
def test_has_test_handler_has_handler_configured() -> None:
    test_class = create_lambda_configuration_tests(
        "func_key", "DefaultFunc", expected_handler="handler.lambda_handler"
    )
...
def test_handler_uses_python_runtime_success() -> None:
    test_class = create_lambda_configuration_tests(
...
def test_handler_uses_python_runtime_fails_when_different() -> None:
    test_class = create_lambda_configuration_tests(
        "func_key", "DefaultFunc", "handler.lambda_handler", expected_runtime="python3.13"
    )
    instance = test_class()
...
def test_handler_uses_expected_architecture_success() -> None:
    test_class = create_lambda_configuration_tests(
...
def test_handler_uses_expected_architecture_fails_when_different() -> None:
    test_class = create_lambda_configuration_tests(
        "func_key", "DefaultFunc", "handler.lambda_handler", expected_architecture="arm64"
    )
    instance = test_class()
...
def test_handler_has_handler_configured_success() -> None:
    test_class = create_lambda_configuration_tests(
        "func_key", "DefaultFunc", expected_handler="handler.lambda_handler"
    )
    instance = test_class()
...
def test_handler_has_handler_configured_fails_when_different() -> None:
    test_class = create_lambda_configuration_tests(
        "func_key", "DefaultFunc", expected_handler="handler.lambda_handler"
    )
    instance = test_class()
...
def test_create_deployed_resource_existence_tests_returns_class() -> None:
...
def test_create_deployed_resource_existence_tests_returns_class_with_name() -> None:
    result = create_deployed_resource_existence_tests(
        "func_key", "DefaultFunc", "TestHandler"
    )
...
def test_has_test_handler_role_exists() -> None:
...
def test_has_test_handler_function_exists() -> None:
    test_class = create_deployed_resource_existence_tests(
        "func_key", "DefaultFunc", "TestHandler"
    )
