...
def test_can_list_buckets_success() -> None:
...
def test_can_list_buckets_fails_on_access_denied() -> None:
    instance = integration_module.Layer6IAMCapabilityTests()
    mock_client = MagicMock()
...
def test_can_list_buckets_reraises_other_errors() -> None:
    instance = integration_module.Layer6IAMCapabilityTests()
    mock_client = MagicMock()
...
def test_can_list_roles_success() -> None:
    instance = integration_module.Layer6IAMCapabilityTests()
    mock_client = MagicMock()
...
def test_can_list_roles_fails_on_access_denied() -> None:
    instance = integration_module.Layer6IAMCapabilityTests()
    mock_client = MagicMock()
...
def test_can_list_roles_reraises_other_errors() -> None:
    instance = integration_module.Layer6IAMCapabilityTests()
    mock_client = MagicMock()
...
def test_can_write_to_bucket_success() -> None:
...
def test_can_write_to_bucket_fails_on_access_denied() -> None:
    instance = integration_module.Layer6S3WriteCapabilityTests()
    mock_client = MagicMock()
...
def test_can_write_to_bucket_reraises_other_errors() -> None:
    instance = integration_module.Layer6S3WriteCapabilityTests()
    mock_client = MagicMock()
...
def test_can_write_to_bucket_cleanup_on_delete_failure() -> None:
    instance = integration_module.Layer6S3WriteCapabilityTests()
    mock_client = MagicMock()
    mock_client.put_object.return_value = {}
...
def test_can_delete_from_bucket_success() -> None:
    instance = integration_module.Layer6S3WriteCapabilityTests()
    mock_client = MagicMock()
    mock_client.put_object.return_value = {}
    mock_client.delete_object.return_value = {}
...
def test_can_delete_from_bucket_fails_on_access_denied() -> None:
    instance = integration_module.Layer6S3WriteCapabilityTests()
    mock_client = MagicMock()
    mock_client.put_object.return_value = {}
...
def test_can_delete_from_bucket_reraises_other_errors() -> None:
    instance = integration_module.Layer6S3WriteCapabilityTests()
    mock_client = MagicMock()
    mock_client.put_object.return_value = {}
    mock_client.delete_object.side_effect = create_client_error("InternalError")
...
def test_can_describe_rest_apis_success() -> None:
...
def test_can_describe_rest_apis_fails_on_access_denied() -> None:
    instance = integration_module.Layer2APIGatewayAuthorizationTests()
    mock_client = MagicMock()
...
def test_can_describe_rest_apis_reraises_other_errors() -> None:
    instance = integration_module.Layer2APIGatewayAuthorizationTests()
    mock_client = MagicMock()
...
def test_can_access_specific_rest_api_fails_when_not_accessible() -> None:
    instance = integration_module.Layer2APIGatewayAuthorizationTests()
...
def test_can_list_functions_success() -> None:
...
def test_can_list_functions_fails_on_access_denied() -> None:
    instance = integration_module.Layer2LambdaAndIAMAuthorizationTests()
    mock_client = MagicMock()
...
def test_can_list_functions_reraises_other_errors() -> None:
    instance = integration_module.Layer2LambdaAndIAMAuthorizationTests()
    mock_client = MagicMock()
...
def test_can_list_roles_iam_success() -> None:
    instance = integration_module.Layer2LambdaAndIAMAuthorizationTests()
    mock_client = MagicMock()
    mock_client.list_roles.return_value = {"Roles": []}
    instance.test_can_list_roles(mock_client)
...
def test_can_list_roles_iam_fails_on_access_denied() -> None:
    instance = integration_module.Layer2LambdaAndIAMAuthorizationTests()
    mock_client = MagicMock()
    mock_client.list_roles.side_effect = create_client_error("AccessDenied")
    with pytest.raises(AssertionError):
...
def test_can_list_roles_iam_reraises_other_errors() -> None:
    instance = integration_module.Layer2LambdaAndIAMAuthorizationTests()
    mock_client = MagicMock()
    mock_client.list_roles.side_effect = create_client_error("InternalError")
    with pytest.raises(AssertionError):
...
def test_api_gateway_id_output_exists_success() -> None:
...
def test_api_gateway_id_output_exists_fails_when_missing() -> None:
    instance = integration_module.Layer4APIBackendPrerequisiteTests()
...
def test_api_gateway_id_output_exists_fails_when_empty() -> None:
    instance = integration_module.Layer4APIBackendPrerequisiteTests()
...
def test_api_gateway_exists_in_aws_success() -> None:
    instance = integration_module.Layer4APIBackendPrerequisiteTests()
    mock_client = MagicMock()
...
def test_api_gateway_exists_in_aws_skips_when_no_id() -> None:
    instance = integration_module.Layer4APIBackendPrerequisiteTests()
    mock_client = MagicMock()
    outputs: Dict[str, str] = {}
    with pytest.raises(pytest.skip.Exception):
...
def test_api_gateway_exists_in_aws_fails_on_not_found() -> None:
    instance = integration_module.Layer4APIBackendPrerequisiteTests()
    mock_client = MagicMock()
...
def test_api_gateway_exists_in_aws_reraises_other_errors() -> None:
    instance = integration_module.Layer4APIBackendPrerequisiteTests()
    mock_client = MagicMock()
...
def test_api_gateway_is_regional_success() -> None:
...
def test_api_gateway_is_regional_skips_when_id_none() -> None:
    instance = integration_module.Layer5APIGatewayRegionalTests()
...
def test_api_gateway_is_regional_skips_when_not_exists() -> None:
    instance = integration_module.Layer5APIGatewayRegionalTests()
...
def test_api_gateway_is_regional_fails_when_not_regional() -> None:
    instance = integration_module.Layer5APIGatewayRegionalTests()
    api_gateway_info = {
        "id": "abc123",
        "exists": True,
...
def test_api_gateway_info_has_id_success() -> None:
    instance = integration_module.Layer5APIGatewayRegionalTests()
    api_gateway_info = {"id": "abc123"}
    assert accepted(instance.test_api_gateway_info_has_id, api_gateway_info)


def test_api_gateway_info_has_id_fails_when_missing() -> None:
    instance = integration_module.Layer5APIGatewayRegionalTests()
    api_gateway_info: Dict[str, Any] = {}
    with pytest.raises(AssertionError):
...
def test_can_get_lambda_function_configuration_success_with_functions() -> None:
...
def test_can_get_lambda_function_configuration_reraises_other_errors() -> None:
    instance = integration_module.Layer6DeploymentCapabilityTests()
    mock_client = MagicMock()
    mock_client.list_functions.return_value = {
        "Functions": [{"FunctionName": "my-function"}]
...
def test_can_create_log_group_dry_run_success() -> None:
    instance = integration_module.Layer6DeploymentCapabilityTests()
    mock_client = MagicMock()
...
def test_can_create_log_group_dry_run_fails_on_access_denied() -> None:
    instance = integration_module.Layer6DeploymentCapabilityTests()
    mock_client = MagicMock()
...
def test_can_create_log_group_dry_run_reraises_other_errors() -> None:
    instance = integration_module.Layer6DeploymentCapabilityTests()
    mock_client = MagicMock()
...
def test_can_get_iam_role_details_success_with_roles() -> None:
    instance = integration_module.Layer6DeploymentCapabilityTests()
    mock_client = MagicMock()
...
def test_can_get_iam_role_details_reraises_other_errors() -> None:
    instance = integration_module.Layer6DeploymentCapabilityTests()
    mock_client = MagicMock()
    mock_client.list_roles.return_value = {"Roles": [{"RoleName": "my-role"}]}
