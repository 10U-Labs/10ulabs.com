...
def test_bootstrap_terraform_initialized(bootstrap_initialized: bool) -> None:
...
def test_central_logs_bucket_arn_output_exists(bootstrap_outputs: Dict[str, str]) -> None:
...
def test_github_actions_role_arn_output_exists(bootstrap_outputs: Dict[str, str]) -> None:
...
def test_central_logs_bucket_name_extracted(central_logs_bucket_name: str) -> None:
...
def test_central_logs_bucket_exists(s3_client: Any, central_logs_bucket_name: str) -> None:
