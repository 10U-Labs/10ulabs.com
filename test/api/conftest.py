...
def api_gateway_event(path, method='GET', body=None, headers=None, path_parameters=None, request_context=None):
    event = {
        'path': path,
        'httpMethod': method,
        'headers': headers or {},
        'pathParameters': path_parameters or {},
        'requestContext': request_context or {'requestId': 'test-request-id'}
    }
    if body is not None:
...
def cloudformation_event(request_type, properties, physical_resource_id=None):
    return {
        ...
        'PhysicalResourceId': physical_resource_id or 'test-physical-id'
    }
