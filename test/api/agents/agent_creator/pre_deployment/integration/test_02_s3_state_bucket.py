"""Tests to validate S3 terraform state bucket before agent_creator deployment.
...
class TestS3BucketCapability:
    ...
    def test_02_can_put_object(self, s3_client, state_bucket_name):
        ...
        test_key = "test/agent_creator_pre_deployment_test.txt"
        try:
    ...
    def test_03_can_get_object(self, s3_client, state_bucket_name):
        ...
        test_key = "test/agent_creator_pre_deployment_test_read.txt"
        try:
            # First put an object
            s3_client.put_object(
                Bucket=state_bucket_name,
