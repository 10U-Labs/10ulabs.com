...
class TestDeployedIAMRoleNamingConventions:
    ...
    def test_echo_handler_role_exists(self, iam_client, config):
        """Verify EchoHandler IAM role exists."""
        function_name = config.get('echo_handler_function_name', 'TenULabsEchoHandler')
    ...
    def test_echo_handler_role_name_is_pascalcase(self, iam_client, config):
        """Verify EchoHandler IAM role name uses PascalCase."""
        function_name = config.get('echo_handler_function_name', 'TenULabsEchoHandler')
        role_name = f"{function_name}ServiceRole"
...
class TestDeployedLambdaFunctionNamingConventions:
    ...
    def test_echo_handler_function_exists(self, lambda_client, config):
        """Verify EchoHandler Lambda function exists."""
        function_name = config.get('echo_handler_function_name', 'TenULabsEchoHandler')
        try:
    ...
    def test_echo_handler_function_name_is_pascalcase(self, lambda_client, config):
        """Verify EchoHandler Lambda function name uses PascalCase."""
        function_name = config.get('echo_handler_function_name', 'TenULabsEchoHandler')
