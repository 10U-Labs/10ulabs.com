"""Layer 7: Capability tests for health endpoint pre-deployment.
...
class TestDeploymentCapabilities(Layer7DeploymentCapabilityTests):
    """Layer 7: Verify capabilities to deploy Lambda, CloudWatch, and IAM.

    All tests inherited from Layer7DeploymentCapabilityTests base class.
    """
