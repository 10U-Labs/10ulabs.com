...
CONTACT_SRC = Path(__file__).parents[6] / "src" / "api" / "endpoints" / "contact"

IAM_ROLES = extract_iam_role_names(CONTACT_SRC / "iam.tf")
LAMBDA_FUNCTIONS = extract_lambda_function_names(CONTACT_SRC / "lambda.tf", use_handler_names=True)
