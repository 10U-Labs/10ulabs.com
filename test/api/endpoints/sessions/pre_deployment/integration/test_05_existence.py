...
def test_api_gateway_existence(apigateway_client: Any, api_gateway_id: Optional[str]) -> None:
...
def test_terraform_state_existence(s3_client: Any, state_bucket_name: str) -> None:
