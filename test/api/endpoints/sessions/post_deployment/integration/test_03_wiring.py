...
class TestHandlerLambdaWiring:
    def test_handler_lambda_can_be_invoked_by_api_gateway(
        self,
        lambda_client: Any,
    ...
    def test_handler_lambda_role_has_dynamodb_policy(
        self,
        iam_client: Any,
        sessions_config: Dict[str, Any]
    ) -> None:
    ...
    def test_handler_lambda_role_has_basic_execution_policy(
        self,
        iam_client: Any,
        sessions_config: Dict[str, Any]
    ) -> None:
...
class TestExportLambdaWiring:
    def test_export_lambda_role_has_export_permissions(
        self,
        iam_client: Any,
        sessions_config: Dict[str, Any]
    ) -> None:
    ...
    def test_export_lambda_role_has_s3_write_permission(
        self,
        iam_client: Any,
        sessions_config: Dict[str, Any]
    ) -> None:
...
def test_scheduler_wiring(iam_client: Any, sessions_config: Dict[str, Any]) -> None:
    response = iam_client.list_role_policies(
...
def test_backup_wiring(backup_client: Any, sessions_config: Dict[str, Any]) -> None:
