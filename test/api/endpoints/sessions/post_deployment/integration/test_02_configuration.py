...
def test_s3_bucket_blocks_public_acls(s3_client: Any, sessions_config: Dict[str, Any]) -> None:
...
def test_s3_bucket_blocks_public_policy(s3_client: Any, sessions_config: Dict[str, Any]) -> None:
    response = s3_client.get_public_access_block(
        Bucket=sessions_config["s3_bucket_name"]
    )
...
def test_s3_bucket_ignores_public_acls(s3_client: Any, sessions_config: Dict[str, Any]) -> None:
    response = s3_client.get_public_access_block(
        Bucket=sessions_config["s3_bucket_name"]
    )
...
def test_s3_bucket_is_not_versioned(s3_client: Any, sessions_config: Dict[str, Any]) -> None:
