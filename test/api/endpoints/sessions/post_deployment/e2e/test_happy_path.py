...
def test_post_returns_200(api_url: str, test_device_id: str, test_session_id: str) -> None:
...
def test_post_returns_success(api_url: str, test_device_id: str, test_session_id: str) -> None:
...
def test_options_returns_cors_headers(api_url: str, test_session_id: str) -> None:
