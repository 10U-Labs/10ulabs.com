...
class TestDeployedIAMRoleNamingConventions:
    ...
    def test_troubleshooter_webhook_role_exists(self, iam_client):
        """Verify TroubleshooterOfWorkflowsWebhook IAM role exists."""
        role_name = "TenULabsTroubleshooterOfWorkflowsWebhookRole"
        try:
            iam_client.get_role(RoleName=role_name)
        except iam_client.exceptions.NoSuchEntityException:
            pytest.fail(f"IAM role '{role_name}' does not exist")

    def test_troubleshooter_webhook_role_name_is_pascalcase(self, iam_client):
        """Verify TroubleshooterOfWorkflowsWebhook IAM role name uses PascalCase."""
        role_name = "TenULabsTroubleshooterOfWorkflowsWebhookRole"
...
class TestDeployedLambdaFunctionNamingConventions:
    ...
    def test_troubleshooter_webhook_function_exists(self, lambda_client):
        """Verify TroubleshooterOfWorkflowsWebhook Lambda function exists."""
        function_name = "TenULabsTroubleshooterOfWorkflowsWebhook"
        try:
            lambda_client.get_function(FunctionName=function_name)
        except lambda_client.exceptions.ResourceNotFoundException:
            pytest.fail(f"Lambda function '{function_name}' does not exist")

    def test_troubleshooter_webhook_function_name_is_pascalcase(self, lambda_client):
        """Verify TroubleshooterOfWorkflowsWebhook Lambda function name uses PascalCase."""
        function_name = "TenULabsTroubleshooterOfWorkflowsWebhook"
