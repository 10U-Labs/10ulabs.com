"""Tests to validate IAM role and credentials before agents/shared deployment.
...
class TestIAMRoleCapability:
    ...
    def test_02_can_call_ecr_describe_repositories(self, ecr_client):
        """Verify we can call ecr:DescribeRepositories (basic ECR permission check)."""
        try:
            ...
            if err.response["Error"]["Code"] == "AccessDeniedException":
                pytest.fail(
                    ...
                    "The role may lack ECR permissions required to manage agent images."
                )
            raise

    def test_03_can_call_iam_list_roles(self, iam_client):
        ...
        try:
            ...
            if err.response["Error"]["Code"] == "AccessDenied":
                pytest.fail(
                    ...
                    "The role may lack IAM permissions required to create execution roles."
                )
            raise
