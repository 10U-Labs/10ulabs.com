...
def test_handler_lambda_exists(lambda_client: Any, handler_function_name: str) -> None:
    try:
...
def test_handler_iam_role_exists(iam_client: Any, handler_role_name: str) -> None:
    try:
...
def test_configurations_table_exists(dynamodb_client: Any, configurations_table_name: str) -> None:
    try:
...
def test_handler_log_group_exists(handler_log_group: Any) -> None:
