...
class TestDeployedIAMRoleNamingConventions:
    ...
    def test_echo_handler_role_name_is_pascalcase(self, iam_client):
        """Verify EchoHandler IAM role name uses PascalCase."""
        # The role is currently named EchoHandler-ServiceRole (with dash)
        role_name = "EchoHandler-ServiceRole"
        try:
