...
class TestLambdaIAMWiring:
    """Layer 3: Verify Lambda is wired to IAM role."""

    def test_simulation_soc_handler_has_iam_role_attached(
    ...
    def test_simulation_soc_handler_role_has_logs_policy(self, iam_client, shared_config):
...
class TestLambdaAPIGatewayWiring:
    """Layer 3: Verify Lambda is wired to API Gateway."""

    def test_simulation_soc_handler_has_api_gateway_permission(
        self, lambda_client, shared_config
    ):
...
class TestLambdaEnvironmentWiring:
    """Layer 3: Verify Lambda environment variables are set correctly."""

    def test_simulation_soc_handler_has_google_client_id(
        self, lambda_client, shared_config
    ):
...
class TestCloudWatchLogsWiring:
    """Layer 3: Verify CloudWatch log group matches Lambda function."""

    def test_cloudwatch_log_group_name_matches_lambda(
        self, handler_log_group, shared_config
    ):
