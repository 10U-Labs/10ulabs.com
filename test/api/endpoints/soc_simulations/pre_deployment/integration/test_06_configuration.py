...
class TestBackendConfiguration:
    ...
    def test_state_bucket_has_versioning_enabled(self, s3_client, state_bucket_name):
    ...
    def test_state_bucket_has_encryption_enabled(self, s3_client, state_bucket_name):
