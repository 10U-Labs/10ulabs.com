...
class TestStateBucketCapability:
    """Tests for Terraform state bucket write capability."""

    def test_can_read_from_state_bucket(self, s3_client, state_bucket_name):
    ...
    def test_can_write_to_state_bucket(self, s3_client, state_bucket_name):
