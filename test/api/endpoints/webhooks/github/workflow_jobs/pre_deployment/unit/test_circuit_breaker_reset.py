...
CB_PATH = '/v1/webhooks/github/workflow-jobs/circuit-breaker'
...
class TestGetCircuitBreakerStatus:
    ...
    def test_06_handles_event_source_mapping_error(self, circuit_breaker_reset):
    ...
    def test_07_handles_concurrency_not_found(self, circuit_breaker_reset):
