...
def _make_circuit_breaker_request(api_url, api_key):
    ...
    return requests.get(
        f"{api_url}/v1/webhooks/github/workflow-jobs/circuit-breaker",
        headers=headers,
...
def test_circuit_breaker_status_endpoint_returns_200_or_503(api_url, api_key):
    """Test GET /v1/webhooks/github/workflow-jobs/circuit-breaker returns status."""
...
def test_circuit_breaker_status_endpoint_returns_json(api_url, api_key):
    """Test GET /v1/webhooks/github/workflow-jobs/circuit-breaker returns JSON response."""
    headers = {"x-api-key": api_key}
    response = requests.get(
        f"{api_url}/v1/webhooks/github/workflow-jobs/circuit-breaker",
        headers=headers,
...
# NOTE: POST /v1/webhooks/github/workflow-jobs/circuit-breaker (reset)
