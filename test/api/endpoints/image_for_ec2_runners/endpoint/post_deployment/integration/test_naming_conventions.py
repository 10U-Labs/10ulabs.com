...
class TestDeployedIAMRoleNamingConventions:
    ...
    def test_image_for_ec2_runners_handler_role_exists(self, iam_client, config):
...
class TestDeployedLambdaFunctionNamingConventions:
    ...
    def test_image_for_ec2_runners_handler_function_exists(self, lambda_client, config):
