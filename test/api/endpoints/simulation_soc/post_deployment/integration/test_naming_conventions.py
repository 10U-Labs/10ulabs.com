...
def test_simulation_soc_handler_role_name_is_pascalcase(iam_client, config):
...
def test_simulation_soc_handler_function_name_is_pascalcase(lambda_client, config):
