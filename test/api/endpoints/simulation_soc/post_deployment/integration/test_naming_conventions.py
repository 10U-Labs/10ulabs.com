...
class TestDeployedIAMRoleNamingConventions:
    ...
    def test_simulation_soc_handler_role_exists(self, iam_client, config):
        """Verify SimulationSocHandler IAM role exists."""
        function_name = config.get(
            'simulation_soc_handler_function_name',
            'TenULabsSimulationSocHandler'
        )
    ...
    def test_simulation_soc_handler_role_name_is_pascalcase(self, iam_client, config):
        """Verify SimulationSocHandler IAM role name uses PascalCase."""
        function_name = config.get(
            'simulation_soc_handler_function_name',
            'TenULabsSimulationSocHandler'
        )
...
class TestDeployedLambdaFunctionNamingConventions:
    ...
    def test_simulation_soc_handler_function_exists(self, lambda_client, config):
        """Verify SimulationSocHandler Lambda function exists."""
        function_name = config.get(
            'simulation_soc_handler_function_name',
            'TenULabsSimulationSocHandler'
        )
    ...
    def test_simulation_soc_handler_function_name_is_pascalcase(self, lambda_client, config):
        """Verify SimulationSocHandler Lambda function name uses PascalCase."""
        function_name = config.get(
            'simulation_soc_handler_function_name',
            'TenULabsSimulationSocHandler'
        )
