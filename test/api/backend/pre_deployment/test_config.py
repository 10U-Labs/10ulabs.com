...
def test_github_webhook_resource_exists():
    webhook_file = Path(__file__).parent.parent.parent.parent.parent / "src" / "api" / "backend" / "github_webhook.tf"
...
def test_ssm_parameter_webhook_secret_uses_random_password():
    ssm_file = Path(__file__).parent.parent.parent.parent.parent / "src" / "api" / "backend" / "ssm.tf"
