...
class TestDeployedIAMRoleNamingConventions:
    ...
    def test_catchall_handler_role_name_is_pascalcase(self, iam_client, config):
        """Verify CatchAllHandler IAM role name uses PascalCase."""
        # The role is named in terraform as CatchAllHandler-ServiceRole
        # This test will verify the deployed name follows PascalCase
...
class TestDeployedLambdaFunctionNamingConventions:
    ...
    def test_catchall_handler_function_name_is_pascalcase(self, lambda_client, config):
