def test_webhook_secret_parameter_exists(ssm_client, config):
...
def test_webhook_secret_parameter_type(ssm_client, config):
    ssm_parameter_name_for_webhook_secret = config["ssm_parameter_name_for_webhook_secret"]
    response = ssm_client.get_parameter(Name=ssm_parameter_name_for_webhook_secret)
    assert response["Parameter"]["Type"] == "String"


def test_webhook_secret_parameter_value_not_placeholder(ssm_client, config):
    ssm_parameter_name_for_webhook_secret = config["ssm_parameter_name_for_webhook_secret"]
