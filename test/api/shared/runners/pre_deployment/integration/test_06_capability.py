"""Layer 6: Capability tests for api/shared/runners pre-deployment.
...
class TestS3Capabilities(Layer6S3CapabilityTests, Layer6S3WriteCapabilityTests):
    ...
    def test_can_read_state_file(
        self, s3_client, state_bucket_name, runners_state_key
    ):
        ...
        try:
            ...
            if e.response["Error"]["Code"] == "403":
                pytest.fail(
                    f"No permission to read '{runners_state_key}' "
