"""Pre-deployment unit tests for api/shared/parameters SSM configuration."""
import re


def test_ssm_tf_defines_ssm_parameter(api_shared_parameters_dir):
...
def test_ssm_parameter_uses_local_name(api_shared_parameters_dir):
...
def test_ssm_parameter_type_is_string(api_shared_parameters_dir):
...
def test_ssm_parameter_has_lifecycle_ignore_value(api_shared_parameters_dir):
...
def test_ssm_parameter_has_tags(api_shared_parameters_dir):
