"""Pytest fixtures for api/shared/docker_repository pre-deployment integration tests.
...
STATE_KEY = "api/shared/docker_repository/terraform.tfstate"


@pytest.fixture(scope="session")
def docker_repository_state_key():
    """Provide the terraform state key for api_shared_docker_repository."""
    return STATE_KEY


@pytest.fixture(scope="session")
def api_shared_docker_repository_src():
    """Provide path to api_shared_docker_repository source directory."""
