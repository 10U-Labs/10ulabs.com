"""Pytest fixtures for api/shared/docker_repository pre-deployment unit tests."""
...
@pytest.fixture(name="api_shared_docker_repository_dir")
def api_shared_docker_repository_dir_fixture():
    """Provide path to api/shared/docker_repository directory."""
