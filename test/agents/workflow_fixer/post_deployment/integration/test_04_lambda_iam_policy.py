...
LAMBDA_ROLE_NAME = "TenULabsWorkflowFixerWebhookRole"
AGENTCORE_POLICY_NAME = "TenULabsWorkflowFixerWebhookAgentCorePolicy"
        ...
        try:
            ...
            if err.response["Error"]["Code"] == "NoSuchEntity":
                pytest.fail(
                    ...
                    f"'{LAMBDA_ROLE_NAME}'. Run terraform apply in src/agents/workflow_fixer/"
                )
            raise
